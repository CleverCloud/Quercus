...
public class PostgresModule extends AbstractQuercusModule {
    ...
    public static Postgres pg_connect(Env env,
        ...
        try {
            ...
            String userName = "";
            String password = "";
            if (connectionString.substring(0, 5).equals("java:")) {
                Postgres postgres = new Postgres(env, connectionString);
            ...
            HashMap<String, String> nameValueMap = parseConnectionString(connectionString);
...
//             "BER2col\tNUMBER3col\tNUMBER4col\t\\N\n";
    ...
    public static ArrayValue pg_get_notify(Env env,
        ...
        try {
            ...
            Method method = cl.getDeclaredMethod("getNotifications", (Class) null);
            ...
            Method methodGetName = cl.getDeclaredMethod("getName", (Class) null);

            // public int getPID();
            Method methodGetPID = cl.getDeclaredMethod("getPID", (Class) null);
    ...
    public static boolean pg_lo_close(Env env,
        ...
        try {
            ...
            Method method = cl.getDeclaredMethod("close", (Class) null);
    ...
    public static LongValue pg_lo_create(Env env,
        ...
        try {
            ...
            Method method = cl.getDeclaredMethod("getLargeObjectAPI", (Class) null);
            ...
            method = cl.getDeclaredMethod("create", (Class) null);
    ...
    public static boolean pg_lo_export(Env env,
        ...
        try {
            ...
            method = cl.getDeclaredMethod("getInputStream", (Class) null);
            ...
            method = cl.getDeclaredMethod("close", (Class) null);
    ...
    public static StringValue pg_lo_read(Env env,
        ...
        try {
            ...
            Method method = cl.getDeclaredMethod("getInputStream", (Class) null);
    ...
    public static int pg_lo_tell(Env env,
        ...
        try {
            ...
            Method method = cl.getDeclaredMethod("tell", (Class) null);
    ...
    public static Value pg_result_error_field(Env env,
        ...
        try {
            ...
            if (serverError != null) {
                ...
                Method method = cl.getDeclaredMethod(methodName, (Class) null);
            ...
            if (fieldCode == PGSQL_DIAG_INTERNAL_POSITION) {
                ...
                if (position.intValue() == 0) // TODO: php/431g return BooleanValue.FALSE;
                {
                    return NullValue.NULL;
                }
            }
