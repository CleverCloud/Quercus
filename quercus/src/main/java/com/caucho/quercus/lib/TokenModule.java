...
public class TokenModule extends AbstractQuercusModule {
   ...
   static final IniDefinition INI_HIGHLIGHT_BG = _iniDefinitions.add("highlight.bg", "#ffffff", PHP_INI_ALL);
   static final IniDefinition INI_HIGHLIGHT_DEFAULT = _iniDefinitions.add("highlight.default", "#0000BB", PHP_INI_ALL);
   static final IniDefinition INI_HIGHLIGHT_HTML = _iniDefinitions.add("highlight.html", "#000000", PHP_INI_ALL);
}
