...
public class MhashModule extends AbstractQuercusModule {
    ...
    private HashMap<Integer, MhashAlgorithm> _algorithmMap = new HashMap<Integer, MhashAlgorithm>();
	...
	if (key.length() > 0) {
	    throw new UnsupportedOperationException("key"); // TODO:
	}
	...
	return LongValue.create(512); // TODO: stubbed
    }
    ...
    // TODO: public String mhash_keygen_s2k(
