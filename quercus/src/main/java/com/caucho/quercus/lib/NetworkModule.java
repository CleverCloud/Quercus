...
public class NetworkModule extends AbstractQuercusModule {
   ...
   private static final LinkedHashMap<String, LongValue> _protoToNum = new LinkedHashMap<String, LongValue>();
   private static final LinkedHashMap<String, ServiceNode> _servToNum = new LinkedHashMap<String, ServiceNode>();
