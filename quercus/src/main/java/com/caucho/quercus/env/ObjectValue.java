...
abstract public class ObjectValue extends Value {
    ...
    */
   // TODO: remove entrySet() and use getIterator() instead
   ...
   public int cmpObject(ObjectValue rValue) {
      ...
      if (aSet.equals(bSet)) {
         ...
         TreeSet<Map.Entry<Value, Value>> aTree = new TreeSet<Map.Entry<Value, Value>>(aSet);

         TreeSet<Map.Entry<Value, Value>> bTree = new TreeSet<Map.Entry<Value, Value>>(bSet);
