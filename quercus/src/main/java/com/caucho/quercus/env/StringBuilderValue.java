...
public class StringBuilderValue
    ...
    public int hashCode() {
        ...
        if (hash != 0) {
            //System.err.println("StringBuilderValue Hash code for 1" + this + " = " + hash);
            return hash;
        }
        ...
        if (length > 256) {
            ...
            _hashCode = hash;
            //System.err.println("StringBuilderValue Hash code for 2" + this + " = " + hash);
            return hash;
        }
        ...
        _hashCode = hash;
        // System.err.println("StringBuilderValue Hash code for 3" + this + " = " + hash);
        return hash;
    }
