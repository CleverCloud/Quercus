...
public class Env {
    ...
    public final Var getStaticVar(StringValue name) {
        ...
        if (var == null) {
            var = new Var();
            //System.err.println("getStaticVar(StringValue name) " + name);
    ...
    public final Value getStaticValue(StringValue name) {
        //System.err.println("getStaticValue(StringValue name) " + name + " of type " + name.getClass().getName());
        //System.err.println("_staticMap " + _staticMap);
        Var var = _staticMap.get(name);
        //System.err.println("_staticMap.get(" + name + ") = " + var + " # " + _staticMap.get(name));
        if (var != null) {
            return var.toValue();
        } else {
            return NullValue.NULL;
    ...
    public final Var setStaticRef(StringValue name, Value value) {
        if (value.isVar()) {
            Var var = (Var) value;
            //System.err.println("setStaticRef(StringValue name, Value value) " + var + " has " + var.hashCode());
            _staticMap.put(name, var);
        ...
        if (var == null) {
            var = new Var();
            //System.err.println("setStaticRef(StringValue name, Value value) => " + name + " hash " + name.hashCode() + " - " + name.getClass().getName() + " - " + value);
            _staticMap.put(name, var);
        }
