...
abstract public class StringValue
    ...
    public boolean eq(Value rValue) {
        //System.err.println("eq " + rValue + " to this " + this);
    ...
    public int hashCode() {
        ...
        //System.err.println("Hash code for " + this + " = " + hash);
        return hash;
    }
    ...
    public int hashCodeCaseInsensitive() {
        ...
        //System.err.println("Hash insensitive code for " + this + " = " + hash);
        return hash;
    }
    ...
    public boolean equalsIgnoreCase(Object o) {
        //System.err.println("equalsIgnoreCase " + o + " to this " + this);
        if (this == o) {
            return true;
        } else if (!(o instanceof StringValue)) {
            return false;
