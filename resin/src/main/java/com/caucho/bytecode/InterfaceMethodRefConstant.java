...
public class InterfaceMethodRefConstant extends ConstantPoolEntry {
  ...
  void write(ByteCodeWriter out)
    throws IOException
  {
    out.write(ConstantPool.CP_INTERFACE_METHOD_REF);
  ...
  {
    return target.addInterfaceRef(getClassName(), getName(), getType()).getIndex();
  }

  public String toString()
  {
    return "InterfaceMethodRefConstant[" + getClassName() + "." + getName() + "(" + getType() + ")]";
  }
}
