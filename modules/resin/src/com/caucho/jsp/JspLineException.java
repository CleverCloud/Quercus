 ...
 * source line numbers.
 */
class JspLineException extends ServletException
  implements ExceptionWrapper, LineMapException, Serializable {
  protected LineMap _lineMap;

  public JspLineException(Throwable e, LineMap lineMap)
  {
    super(e);
