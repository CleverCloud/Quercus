...
public class ParamValuesFieldExpression extends AbstractValueExpression
{
  ...
  ParamValuesFieldExpression(String field)
  {
    _field = field;
  }
    ...
    throws ELException
  {
    if (! (env instanceof ServletELContext)) {
      ...
      Object scope = elResolver.getValue(env, null, "paramValues");
    ...
    return servletEnv.getParameterValues(_field);
  }

  public String getExpressionString()
  {
    return "paramValues['" + _field + "']";
  }
}
