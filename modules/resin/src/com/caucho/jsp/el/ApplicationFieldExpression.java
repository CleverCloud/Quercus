...
public class ApplicationFieldExpression extends AbstractValueExpression
{
  ...
  ApplicationFieldExpression(String field)
  {
    _field = field;
  }
    ...
    throws ELException
  {
    if (! (env instanceof ServletELContext)) {
      ...
      Object scope = elResolver.getValue(env, null, "applicationScope");
    ...
    return webApp.getAttribute(_field);
  }
    ...
    throws ELException
  {
    ...
    webApp.setAttribute(_field, value);
  }

  public String getExpressionString()
  {
    return "applicationScope['" + _field + "']";
  }
}
