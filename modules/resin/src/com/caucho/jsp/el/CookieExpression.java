...
public class CookieExpression extends AbstractValueExpression
  implements FieldGenerator
{
  public static final ValueExpression EXPR
    = new CookieExpression();

  public ValueExpression createField(String field)
  {
    return new CookieFieldExpression(field);
  }
    ...
    throws ELException
  {
    if (! (env instanceof ServletELContext))
      return env.getELResolver().getValue(env, null, "cookie");

    ServletELContext servletEnv = (ServletELContext) env;
    
    return servletEnv.getCookie();
  }
