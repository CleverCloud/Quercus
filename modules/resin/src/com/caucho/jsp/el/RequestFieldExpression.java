...
public class RequestFieldExpression extends AbstractValueExpression
{
  private final String _field;
  
  RequestFieldExpression(String field)
  {
    _field = field;
  }
    ...
    throws ELException
  {
    if (! (env instanceof ServletELContext)) {
      ...
      Object scope = elResolver.getValue(env, null, "requestScope");
    ...
    return request.getAttribute(_field);
  }
    ...
    throws ELException
  {
    ...
    request.setAttribute(_field, value);
  }

  public String getExpressionString()
  {
    return "requestScope['" + _field + "']";
  }
}
