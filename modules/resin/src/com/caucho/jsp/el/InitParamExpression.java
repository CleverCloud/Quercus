...
public class InitParamExpression extends AbstractValueExpression
  implements FieldGenerator
{
  public static final ValueExpression EXPR
    = new InitParamExpression();

  public ValueExpression createField(String field)
  {
    return new InitParamFieldExpression(field);
  }
    ...
    throws ELException
  {
    if (! (env instanceof ServletELContext))
      return env.getELResolver().getValue(env, null, "initParam");
    
    env.setPropertyResolved(true);
    
    ServletContext app = ((ServletELContext) env).getApplication();
