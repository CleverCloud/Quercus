...
public class HessianContextImpl extends ContextImpl {
   ...
   */
  public HessianContextImpl(AbstractModel model, Hashtable env)
  {
    super(model, env);
  }
   ...
   * @param env The client's JNDI environment.
   */
  public HessianContextImpl(String name, AbstractModel model, Hashtable env)
  {
  ...
  {
    return new HessianContextImpl(name, model, env);
  }
