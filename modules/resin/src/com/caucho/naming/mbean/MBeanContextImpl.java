...
/**
 * MBean implementation of the JNDI <code>Context</code>.
 *  The actual storage of the persistent data is in
 * the <code>AbstractModel</code>.
 */
public class MBeanContextImpl extends ContextImpl {
  protected static final Logger dbg
    = Logger.getLogger(MBeanContextImpl.class.getName());
  protected static final L10N L = new L10N(MBeanContextImpl.class);
   ...
   */
  public MBeanContextImpl(AbstractModel model, Hashtable env)
  {
    super(model, env);
  }
   ...
   * @param env The client's JNDI environment.
   */
  public MBeanContextImpl(String name, AbstractModel model, Hashtable env)
  {
  ...
  {
    return new MBeanContextImpl(name, model, env);
  }
  ...
  {
    return "MBeanContextImpl[" + getName() + "]";
  }
}
