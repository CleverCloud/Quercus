...
/*
 * Parent class of all SNMP request PDU types.
 */
abstract public class RequestPduValue extends PduValue
{
  ...
  public RequestPduValue(int requestId,
                         int error,
                         int errorIndex)
  {
  ...
  public RequestPduValue(IntegerValue requestId,
                         IntegerValue error,
