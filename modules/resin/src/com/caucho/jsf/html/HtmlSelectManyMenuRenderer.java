...
/**
 * The HTML selectMany/menu renderer
 */
class HtmlSelectManyMenuRenderer extends SelectRenderer
{
  public static final Renderer RENDERER
    = new HtmlSelectManyMenuRenderer();
    ...
    throws IOException
  {
    ...
    if (component instanceof HtmlSelectManyMenu) {
      ...
      values = htmlComponent.getSelectedValues();
    }
    else {
      ...
      values = (Object []) attrMap.get("selectedValues");
    }
    ...
    out.writeAttribute("multiple", "multiple", "multiple");
