...
public class MapBeanProgram extends BeanProgram
{
  ...
  public MapBeanProgram(AbstractValue key, AbstractValue value)
  {
    _key = key;
    _value = value;
  }
  ...
  {
    ((Map) bean).put(_key.getValue(context), _value.getValue(context));
  }
}
