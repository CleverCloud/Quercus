...
public class AmberObjectNotFoundException extends AmberRuntimeException {
   ...
   */
  public AmberObjectNotFoundException(String message)
  {
    super(message);
  }
   ...
   */
  public AmberObjectNotFoundException(String message, Throwable e)
  {
    super(message, e);
  }
   ...
   * @param e the rootCause exception
   */
  public AmberObjectNotFoundException(Throwable e)
  {
    super(e);
  }
}
