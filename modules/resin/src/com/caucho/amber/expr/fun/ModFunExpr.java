 ...
 */
public class ModFunExpr extends FunExpr {
  private static final L10N L = new L10N(ModFunExpr.class);

  /**
   * Creates a new expression
   */
  protected ModFunExpr(QueryParser parser,
                       ArrayList<AmberExpr> args)
  {
    super(parser, "mod", args, false);
  }

  public static FunExpr create(QueryParser parser,
                               ArrayList<AmberExpr> args)
  {
    return new ModFunExpr(parser, args);
  }
                             ...
                             boolean select)
  {
    ...
    // if (n != 2)
    //   throw new QueryParseException(L.l("expected 2 arguments for MOD"));
