 ...
 */
public class LengthFunExpr extends FunExpr {
  private static final L10N L = new L10N(LengthFunExpr.class);

  /**
   * Creates a new expression
   */
  protected LengthFunExpr(QueryParser parser,
                          ArrayList<AmberExpr> args)
  {
    super(parser, "length", args, false);
  }

  public static FunExpr create(QueryParser parser,
                               ArrayList<AmberExpr> args)
  {
    return new LengthFunExpr(parser, args);
  }
                             ...
                             boolean select)
  {
    ...
    // if (n != 1)
    //   throw new QueryParseException(L.l("expected 1 string argument for LENGTH"));
