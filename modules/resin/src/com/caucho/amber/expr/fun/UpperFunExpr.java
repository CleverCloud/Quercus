 ...
 */
public class UpperFunExpr extends FunExpr {
  private static final L10N L = new L10N(UpperFunExpr.class);

  /**
   * Creates a new expression
   */
  protected UpperFunExpr(QueryParser parser,
                         ArrayList<AmberExpr> args)
  {
    super(parser, "upper", args, false);
  }

  public static FunExpr create(QueryParser parser,
                               ArrayList<AmberExpr> args)
  {
    return new UpperFunExpr(parser, args);
  }
                             ...
                             boolean select)
  {
    ...
    // if (n != 1)
    //   throw new QueryParseException(L.l("expected 1 string argument for UPPER"));
