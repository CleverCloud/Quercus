 ...
 */
public class AbsFunExpr extends FunExpr {
  private static final L10N L = new L10N(AbsFunExpr.class);

  /**
   * Creates a new expression
   */
  protected AbsFunExpr(QueryParser parser,
                       ArrayList<AmberExpr> args)
  {
    super(parser, "abs", args, false);
  }
