...
public class XtpDirectivePage extends XslNode implements XslTopNode {
  ...
  {
    if (name.getName().equals("errorPage"))
      _gen.setErrorPage(value);
    else if (name.getName().equals("import"))
      _gen.addImportList(value);
    else if (name.getName().equals("contentType"))
      _gen.setContentType(value);
    else
