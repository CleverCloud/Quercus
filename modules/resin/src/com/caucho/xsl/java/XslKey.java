...
public class XslKey extends XslNode implements XslTopNode {
    ...
    throws XslParseException
  {
    if (name.getName().equals("name"))
      _name = value;
    else if (name.getName().equals("match"))
      _match = value;
    else if (name.getName().equals("use"))
      _use = value;
    else if (name.getName().equals("as"))
      _as = value;
    else if (name.getName().equals("collation"))
      _collation = value;
    else
  ...
  public void endElement()
    throws Exception
  {
    _gen.addKey(_name, parseMatch(_match), parseExpr(_use));
  }
