 ...
 */
public class XslPreserveSpace extends XslNode implements XslTopNode {
  ...
  {
    if ("elements".equals(name.getName())) {
      _elements = value;
    }
    else
  ...
  {
    if (_elements != null)
      _gen.addPreserveSpace(_elements);
  }
