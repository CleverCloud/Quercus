 ...
 */
public class XslNamespaceNode extends XslNode {
  private QName _name;
  private String _value;

  public XslNamespaceNode(QName name, String value)
  {
    _name = name;
    _value = value;
  }
    ...
    throws Exception
  {
    ...
    if (name.equals("xmlns")) {
      ...
      out.print(name == null ? ", null" : (", \"" + name + "\""));
      out.println(");");
      printAttributeValue(out, _value);
      out.println("out.popAttribute();");
    }
