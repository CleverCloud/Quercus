...
public class HessianContext extends ContextImpl {
  /**
   * Creates a new Hessian Context.
   */
  HessianContext(AbstractModel model, Hashtable env)
  {
    super(model, env);
  }
   ...
   * Creates a new Hessian Context.
   */
  HessianContext(String name, AbstractModel model, Hashtable env)
  {
  ...
  {
    return new HessianContext(name, model, env);
  }
}
