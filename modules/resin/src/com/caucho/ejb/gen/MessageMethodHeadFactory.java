 ...
 */
@Module
public class MessageMethodHeadFactory<X> extends MethodHeadFactory<X>
{
  public MessageMethodHeadFactory(MessageAspectBeanFactory<X> beanFactory,
                                   ...
                                   boolean isEnhanced)
  {
    ...
    return new MessageMethodHeadGenerator<X>(this, method, next);
  }
}
