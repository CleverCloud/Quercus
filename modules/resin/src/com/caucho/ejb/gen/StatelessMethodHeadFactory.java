 ...
 */
@Module
public class StatelessMethodHeadFactory<X> extends MethodHeadFactory<X>
{
  public StatelessMethodHeadFactory(StatelessAspectBeanFactory<X> beanFactory,
                                   ...
                                   boolean isEnhanced)
  {
    ...
    return new StatelessMethodHeadGenerator<X>(this, method, next);
  }
}
