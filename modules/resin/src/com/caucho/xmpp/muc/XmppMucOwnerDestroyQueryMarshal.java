 ...
 * </pre></code>
 */
public class XmppMucOwnerDestroyQueryMarshal extends AbstractXmppMarshal {
  private static final Logger log
    = Logger.getLogger(XmppMucOwnerDestroyQueryMarshal.class.getName());
  ...
  {
    return MucOwnerDestroyQuery.class.getName();
  }
  ...
  {
    MucOwnerDestroyQuery mucOwner = (MucOwnerDestroyQuery) object;
    ...
    if (mucOwner.getReason() != null)
      out.writeAttribute("reason", mucOwner.getReason());
