...
/**
 * Creates a fixed javascript legend that hides and shows reference data
 * sections such as schemas, descriptions, etc.
 */
public class ReferenceLegend implements ContentItem {
