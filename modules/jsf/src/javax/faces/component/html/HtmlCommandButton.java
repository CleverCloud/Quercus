...
public class HtmlCommandButton extends UICommand
{
  ...
  private ValueExpression _imageExpr;
  ...
  public String getImage()
  {
    if (_image != null)
      return _image;
    else if (_imageExpr != null)
      return Util.evalString(_imageExpr);
    else
      return null;
  }
  ...
  static {
    ...
    _propMap.put("image", PropEnum.IMAGE);
