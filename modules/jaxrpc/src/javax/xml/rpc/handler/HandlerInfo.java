...
public class HandlerInfo implements java.io.Serializable {
   ...
   */
  public Class setHandlerClass()
  {
    return this.handlerClass;
  }

  /**
   * Sets the handler config map.
   */
  ...
  {
    QName []headers = new QName[this.headers.size()];

    for (int i = 0; i < headers.length; i++)
      headers[i] = (QName) this.headers.get(i);
