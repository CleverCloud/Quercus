...
/**
 * Statistics interface for a JDBC connection pool.
 */
public interface JDBCConnectionPoolStats extends JDBCConnectionStats {
  /**
   * Returns the number of connections that have been created.
   */
  public CountStatistic getCreateCount();

  /**
   * Returns the number of connections that have been closed.
   */
