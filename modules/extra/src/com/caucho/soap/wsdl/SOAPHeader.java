...
public class SOAPHeader extends WSDLExtensibilityElement {
  ...
  public void addFault(SOAPHeaderFault fault)
  {
    if (_faults == null)
      _faults = new ArrayList<SOAPHeaderFault>();

    _faults.add(fault);
  }

  public List<SOAPHeaderFault> getFaults()
  {
    if (_faults == null)
      _faults = new ArrayList<SOAPHeaderFault>();
