 ...
 */
public class DoubleArrayProperty extends ArrayProperty {
  private static final L10N L = new L10N(DoubleArrayProperty.class);

  public static final DoubleArrayProperty PROPERTY = new DoubleArrayProperty();

  public DoubleArrayProperty()
  {
