...
import com.caucho.soa.encoding.ProviderEncoding;
...
/**
 * Passes requests to javax.xml.ws.Providers.
 */
public class ProviderServlet extends GenericServlet implements ProtocolServlet
{
  protected static Logger log
    = Logger.getLogger(ProviderServlet.class.getName());
  
  private ProviderEncoding _provider;
