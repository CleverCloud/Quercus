...
import com.caucho.soa.rest.HessianRestProxy;
...
public class HessianRestEncodingProxyFactory implements EncodingProxyFactory {
  private static final L10N L = new L10N(HessianRestEncodingProxyFactory.class);
